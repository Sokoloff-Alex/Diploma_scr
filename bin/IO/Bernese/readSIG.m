function SSCCRD = readSIG(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   SSCCRD = IMPORTFILE(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   SSCCRD = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   SSCCRD = importfile('SSC_CRD.SIG', 5, 97);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2016/02/25 14:01:16
...
formatSpec = '%s%s%f%f%f%*s%*s%*s%*s%*s%*s%[^\n\r]';
