function [SplittedSites] = load_splitted_sites()
%
%
...
% SplittedSites_list = {'AJAC','AUTN','AXPV','BRST','BSCN','BZRG','CHIZ', ...
%                       'COMO','DRES','EGLT','ENTZ','GARI','GENO','GRAS', ...
%                       'GRAZ','GSR1','IENG','IGMI','KARL','LINZ','LROC', ...
%                       'MARS','MEDI','MLVL','MOPS','PFA2','PORE','POTS', ...
%                       'PRAT','PUYV','ROVE','SBG2','SJDV','SPRN','TLSE', ...
%                       'TORI','TRF2','UNPG','VEN1','VFCH','WTZR','ZADA', ...
%                       'ZIM2','ZIMM','ZOUF'};
